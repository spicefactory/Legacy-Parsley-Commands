 ...
 * @author Jens Halm
 */
public class OverrideResultCommand {
	...
	public function result (result: String, trigger: TestEvent, processor: CommandObserverProcessor): void {
		processor.changeResult(result + ":modified");
	}
