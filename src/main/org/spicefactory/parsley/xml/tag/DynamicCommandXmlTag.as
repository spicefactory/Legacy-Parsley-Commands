...
import org.spicefactory.parsley.tag.messaging.DynamicCommandTag;

[XmlMapping(elementName="dynamic-command")]
/**
 * Represents the dynamic-command XML tag.
 * 
 * @author Jens Halm
 */
public class DynamicCommandXmlTag extends DynamicCommandTag {
